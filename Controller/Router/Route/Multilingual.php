...
class ZFMultilingual_Controller_Router_Route_Multilingual extends Zend_Controller_Router_Route_Abstract
{
	...
	public function setLocaleParameter($param)
	{
		$this->_localeParam = $param;
		return $this;
	}
    ...
    public function assemble($data = array(), $reset = false, $encode = false, $partial = false)
    {
        if ($this->_isTranslated) {
            ...
            if (isset($data['@locale'])) {
            	...
            	if (isset($this->_localeParam)) {
            		if (isset($data[$this->_localeParam])) {
            			$locale = $data[$this->_localeParam];
            		}
            	}
            }
        }
        ...
        foreach (array_reverse($url, true) as $key => $value) {
            ...
            if ($flag || $value !== $defaultValue || $partial) {
                ...
                if ($value !== $defaultValue) $return = $this->_urlDelimiter . $value . $return;
                $flag = true;
            }
        }
